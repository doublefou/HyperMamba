...
class main_model(nn.Module):
    ...
    def __init__(self, num_classes, patch_size=4, in_chans=3, embed_dim=96, depths=(2, 2, 2, 2),
        ...
        self.fu3 = GLE_block(ch_1=384, ch_2=384, r_2=16, ch_int=384, ch_out=384, drop_rate=GLE_dp)
        self.fu4 = GLE_block(ch_1=768, ch_2=768, r_2=16, ch_int=768, ch_out=768, drop_rate=GLE_dp)
